...
// Define Constant
define( 'PT_CV_VERSION_PRO', '7.2.1' );
define( 'PT_CV_REQUIRE_FREE', '4.1' );
...
if ( class_exists( 'PT_Content_Views' ) ) {
	...
	include_once( PT_CV_PATH_PRO . 'elementor/_functions.php' );
	include_once( PT_CV_PATH_PRO . 'elementor/_hooks.php' );
