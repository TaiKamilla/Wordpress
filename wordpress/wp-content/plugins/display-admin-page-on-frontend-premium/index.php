...
// wp-admin page it redirects to comments.php by mistake. It's a wp bug
			$url = remove_query_arg(array('post', 'token', '_wpnonce', 'user_id', 'wp_http_referer', 's', 'page_id', 'revision', 'tag_ID', 'wpfa_id', 'trid', 'vgfa_blacklisted_url', 'vgfa_internal', 'updated', 'vgfa_source'), $url);
