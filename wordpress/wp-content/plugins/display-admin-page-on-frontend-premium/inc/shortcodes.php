		...
		function get_login_form($atts = array(), $content = '') {
			...
			if (is_user_logged_in()) {
				...
				if (VG_Admin_To_Frontend_Obj()->is_master_user()) {
					...
					$blog_id = WPFA_Global_Dashboard_Obj()->get_site_id_for_admin_content();
					$redirect_to = str_replace(array('{user_site_base_url}', 'http://{user_site_base_url}', 'https://{user_site_base_url}', 'http://user_site_base_url', 'https://user_site_base_url'), get_site_url( $blog_id ), $redirect_to);
