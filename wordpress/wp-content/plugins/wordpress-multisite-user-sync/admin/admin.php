                                                    ...
                                                    <td class="title column-title page-title">
                                                        ...
                                                        <?php
                                                            if ( $sites != null ) {
                                                                ...
                                                                if ( $user_synced != null ) {                                                                
                                                                    echo '<b>'; esc_html_e( 'Synced: ', 'wordpress-multisite-user-sync' ); echo '</b>';
                                                        ...
                                                        if ( $sites != null ) {
                                                            foreach ( $sites as $key => $value ) { 
                                                                if ( $wmus_source_blog != $value->blog_id ) {
                                                                    $blog_details = get_blog_details( $value->blog_id );
                                                                    ?>
                                                                        <label><input name="wmus_destination_blogs[]" type="checkbox" value="<?php echo esc_attr( $value->blog_id ); ?>"><?php echo esc_html( $value->domain ); echo esc_html( $value->path ); echo ' ('.esc_html( $blog_details->blogname ).')'; ?></label><br>
                                                                    <?php
                                                                }
                                                            }
                                                        }
